...
namespace Module06_model.Controllers
{
    public class PhotosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Author,ImageUrl,CreatedDate")] Photo photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Author,ImageUrl,CreatedDate")] Photo photo)
        {
            if (id != photo.Id)
            {
                return NotFound();
